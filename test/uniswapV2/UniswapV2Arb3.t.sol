...
import {UniswapV2Arb3} from "../../src/UniswapV2/UniswapV2Arb3.sol";
...
contract UniswapV2Arb3Test is Test {
    ...
    UniswapV2Arb3 private arb;

    function setUp() public {
        arb = new UniswapV2Arb3();
    ...
    function test_flashSwap() public {
        ...
        // Profit 3525.409677221691 for 100500
        uint256 optimalAmountIn = arb.getOptimalAmountIn(uniReserve0, uniReserve1, sushiReserve0, sushiReserve1);
        // Profit 3572.63163417525 for 89000
        //uint256 optimalAmountIn = 86254*1e18;

        console2.log("optimalAmountIn", optimalAmountIn);
        vm.startPrank(user);
