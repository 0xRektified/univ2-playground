...
contract UniswapV2AddLiquidityTest is Test {
    ...
    (uint amountA, uint amountB, uint liquidity ) = router.addLiquidity(WETH, DAI, 1*1e18, 2600*1e18, 1*1e18, 2500*1e18, user, block.timestamp);
    ...
    (uint amountAReturned, uint amountBReturned) = router.removeLiquidity(WETH, DAI, liquidity, 99*1e16, 2500*1e18, user, block.timestamp);
